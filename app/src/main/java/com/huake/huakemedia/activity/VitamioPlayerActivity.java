...
import com.huake.huakemedia.view.MyVitamioView;
...
public class VitamioPlayerActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    MyVitamioView mActivityVideoview;
    ...
    private Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case PROGRESS:
                    //设置进度条
                    int currentPosition = (int) mActivityVideoview.getCurrentPosition();
                    ...
                    if (!isUseSystem && mActivityVideoview.isPlaying()) {
                        ...
                        if (buffer < 500) {
                            String netSpeed = CommonUtils.getNetSpeed(VitamioPlayerActivity.this);
                            if (isNetUrl) {
    ...
    class MyVideoPreparedListener implements MediaPlayer.OnPreparedListener {
        ...
        public void onPrepared(MediaPlayer mp) {
            ...
            //得到视频宽高
            int duration = (int) mActivityVideoview.getDuration();
        ...
        public boolean onInfo(MediaPlayer mp, int what, int extra) {
            switch (what) {
                case MediaPlayer.MEDIA_INFO_BUFFERING_START:
                    Toast.makeText(VitamioPlayerActivity.this, "视频开始卡了", Toast.LENGTH_SHORT).show();
                    break;
                case MediaPlayer.MEDIA_INFO_BUFFERING_END:
                    Toast.makeText(VitamioPlayerActivity.this, "视频卡结束了", Toast.LENGTH_SHORT).show();
                    break;
            }
            return true;
        }
    ...
    private void choiceVitamio() {
        ...
        builder.setTitle("vitamio播放器");
        builder.setMessage("是否使用原来的播放器");
